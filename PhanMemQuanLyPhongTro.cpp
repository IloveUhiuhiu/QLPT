...
void menu_Manager_Phong_Tro()
{
    ...
    do
    {
        ...
        case 6:
            ...
            getline(cin,ID);
            if (ID.size()) Phong::delete_room(ID);
        ...
        {   
            ...
            getline(cin,ID);
            if (ID.size()) Phong::cancel_room(ID);
...
void menu_Manager_Dien_Nuoc()
{
    ...
    do
    {
        ...
        case 6:
            ...
            gotoXY(4,5);cout << "Current Cost Electric: " << DienNuoc::getNewCostElectric() << endl;
            cin.ignore();
        ...
        case 7:
            ...
            gotoXY(4,5);;cout << "Current Cost Water: " << DienNuoc::getNewCostWater() << endl;
            cin.ignore();
